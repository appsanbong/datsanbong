 <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin/theloai/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i>Phòng Thí Nghiệm<span class="fa arrow"></span></a>
                          ...
                          <li>
                            <a href="admin/truong/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i>Cơ Sở<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="admin/loaiphong/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i>Loại Phòng<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/loaiphong/danhsach">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="admin/loaiphong/them">Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="admin/loaiphong/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i>Đặt Phòng<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/datphong/danhsach">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="admin/datphong/them">Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
